...
//#undef	CPU_VENDOR_OS "i386-pc-bsdi3.0"
...
#undef	HAVE_GETRUSAGE_PROTO	/* <sys/resource.h> */
...
#undef	IPV4			/* IPv4, uppercase V name */
#undef	IPv4			/* IPv4, lowercase v name, just in case */
